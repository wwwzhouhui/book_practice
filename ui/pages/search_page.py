...
def create_search_page():
    ...
    with gr.Column() as search_page:
        ...
        # 错题详情展示区
        question_detail_row = gr.Row(visible=False)
        
        with question_detail_row:
            gr.Markdown("## 错题详情")
...
"""
                    return [
                        True,                                # question_detail_row visible
        ...
        def delete_and_refresh(selected_id):
            ...
            # 返回状态和刷新的数据
            return status_msg, refresh_msg, refreshed_data
        ...
        delete_button.click(
            ...
            outputs=[status, query_status, results]
        )
